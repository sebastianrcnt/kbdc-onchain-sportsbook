...
/// @notice Mock token that returns false on transfer/transferFrom instead of reverting
/// @dev Some tokens (e.g., ZRX) return false on failure instead of reverting
